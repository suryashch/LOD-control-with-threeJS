...
📂 Repository Structure
    ...
    /hosting-3d-model: Contains the core three.js implementation and logic.

    /img: Documentation assets and performance comparison captures.

    per-object-lod-control-with-threejs.md: The full research paper and technical breakdown.
